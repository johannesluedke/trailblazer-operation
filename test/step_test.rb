...
class StepTest < Minitest::Spec
  ...
  MyMacro = lambda do |(options, flow_options), *|
    options["e"] = options[:e]
  ...
  #-
  # not existent :name
  # rubocop:disable Style/BlockDelimiters, Style/MethodCalledOnDoEndBlock
  it do
  ...
  # rubocop:enable Style/BlockDelimiters, Style/MethodCalledOnDoEndBlock
